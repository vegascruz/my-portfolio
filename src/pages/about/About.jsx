  ...
  return (
    <div className='text-center p-10'>
          ...
          <h3 className="text-xl py-2">
            ...
            fighting games like Mortal Kombat, and I also love RPG&apos;s like God of War and Dark Souls. I also love to watch TV, especially anime. Animes like Naruto, Dragonball, 
          ...
          <h3 className="text-xl py-2">
            ...
            I am currently in search for a Full-Stack or Web Developer job. I love front end, but am growing to understand/like backend. 
